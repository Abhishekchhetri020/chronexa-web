# Chronexa Web — Missing-Feature Gap Audit vs EduPage/aSc Timetables

**Audit date:** 2026-05-19
**Audited build:** APP_VER `20260519-p2-w6` (live at https://abhishekchhetri020.github.io/chronexa-web/)
**Method:** Read existing reverse-engineering at `/Users/abhishekchhetri/Downloads/Cloning ASC/EDUPAGE_*.md` (15 R-series docs covering the wizard, toolbar, per-entity actions, ops wire, drag UX, collab, E1–E5 surfaces). Diff against actual JS in `/Users/abhishekchhetri/Developer/chronexa_web/js/ui/`. No re-clicking — the docs cover everything we need.
**Sources cited verbatim** (paths relative to `/Users/abhishekchhetri/Downloads/Cloning ASC/`):
- `EDUPAGE_FEATURE_MAP_2026-05-03.md` — wizard root, School step, Days, Breaks
- `EDUPAGE_FEATURE_MAP_WIZARD_2_5_R5.md` — Subjects / Classes / Classrooms cdefs
- `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` — Teachers, Lessons, End-step, Students/Seminars/Supervisions, Relations
- `EDUPAGE_FEATURE_MAP_PER_ENTITY_ACTIONS_R8.md` — Time-off / Constraints / Divisions / Lessons sub-actions
- `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` — 8 ribbon menus
- `EDUPAGE_OPS_DEEP_DIVE_R2.md` — 22-`__func` wire census
- `EDUPAGE_RE_GAPS_2026-05-03.md` — entity catalogue
- `EDUPAGE_E1_FILE_MENU_2026-05-03.md` — File menu items, Compare, Print preview ribbon swap
- `EDUPAGE_E2_GRID_INTERACTIONS_2026-05-03.md` — main grid right-click matrix
- `EDUPAGE_E3_COLOR_TAXONOMY_2026-05-03.md` — color-source decision tree
- `EDUPAGE_E4_EDITOR_TOOLBAR_2026-05-03.md` — sidebar / panel inventory
- `EDUPAGE_E5_EDIT_UNDO_REDO_2026-05-03.md` — keyboard shortcuts, undo RPC
- `EDUPAGE_DRAG_UX_R9.md` — click-pickup, heatmap, testPing
- `EDUPAGE_COLLAB_UX_R10.md` — `tt_docs.apps`, pollChangeEvents
- `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` — REAL-DATA pass (1269 cards), Verification, Generator, Test, Statistics, Advisor
...
| Severity | Count |
|---|---:|
| P0 — blocks completion / breaks a documented EduPage flow | **19** |
...
Source: `EDUPAGE_E1_FILE_MENU_2026-05-03.md` §a + `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` "Files menu". Chronexa side: `js/ui/ribbon/menus/files_menu.js`.

### 1.1 Import — aSc Timetables XML
- **EduPage location:** Files → Import → "aSc Timetables XML"
...
- **Chronexa status:** ✅ at parity (browser-side parser at `js/xml/parse_asc_xml.js`).
- **Code anchor:** `js/ui/io/import_asc_xml.js:1`
- **Source:** `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` Files §1
- **Priority:** — (shipped)

### 1.2 Import — EduPage Basic school data
- **EduPage location:** Files → Import → "Edupage — Basic school data"
- **What it does:** Pull teachers/classes/subjects from school's EduPage account.
- **Wire shape:** `importEdupage` RPC.
- **Chronexa status:** 🟨 stub. `files_menu.js:23` marks `soon: true`. File `js/ui/io/import_edupage_basic.js` exists (107 lines) but no menu wiring.
- **Code anchor:** `js/ui/io/import_edupage_basic.js`
- **Source:** `EDUPAGE_E1_FILE_MENU_2026-05-03.md` §a; `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` Files §3
- **Priority:** P2

### 1.3 Import — EduPage Bell times
- **EduPage location:** Files → Import → "Edupage — Bell times"
- **Chronexa status:** 🟨 stub. `files_menu.js:24` `soon: true`. File `import_edupage_bell_times.js` exists (84 lines) but orphan.
- **Source:** `EDUPAGE_E1_FILE_MENU_2026-05-03.md` §a
- **Priority:** P2

### 1.4 Import — Clipboard
- **EduPage location:** Files → Import → "Import from Clipboard"
- **Wire:** `importClipboard` RPC.
- **Chronexa status:** 🟨 stub. `files_menu.js:25` `soon: true`. File `import_clipboard.js` (109 lines) orphan.
- **Source:** `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` Files §7
- **Priority:** P2

### 1.5 Import — EduPage Timetable
- **EduPage location:** Files → Import → "Edupage — Timetable"
- **Wire:** `importEdupage` / `doImportEdupageAuto` RPCs.
...
### 1.7 Import — WinProsa
- **EduPage location:** Per `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` Files §2 — `importWinprosa` RPC.
...
- **Source:** `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` Files §5
- **Priority:** P2

### 1.9 Export — aSc Timetables `.roz` (native binary)
- **EduPage location:** Files → Export → "aSc Timetables (*.roz)"
- **Chronexa status:** 🟨 stub. `files_menu.js:30` `soon: true`. File `export_asc_roz.js` (75 lines) orphan.
- **Source:** `EDUPAGE_E1_FILE_MENU_2026-05-03.md` §a
- **Priority:** P2 (proprietary binary; XML covers most needs)

### 1.10 Export — aSc Timetables XML
- **Chronexa status:** ✅ shipped. `js/ui/io/export_asc_xml.js:1`
- **Priority:** — (shipped)

### 1.11 Export — Excel (Contracts / Available teachers / Room supervision / Timetable) (4 variants)
- **EduPage location:** Files → Export → "Export to MS Excel — Contracts / Available teachers / Room supervision / Timetable"
...
- **EduPage location:** Files → Compare → "Compare with last saved version"
- **What it does:** Per `EDUPAGE_E1_FILE_MENU_2026-05-03.md` §a — spawns server diff job.
- **Wire shape:** `calcTtSnapshotVersionsDiffs` — verbatim from `EDUPAGE_OPS_DEEP_DIVE_R2.md` §7:
  ```
...
- **EduPage location:** Files → "Show demo files" (toggle on TT picker)
...
Source: `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` "Specification menu" + `EDUPAGE_FEATURE_MAP_2026-05-03.md` §1. Chronexa: `js/ui/ribbon/menus/specification_menu.js` + `js/ui/entity_router.js`.

### 2.1 Bell times / Periods dialog (multi-bell-schedule)
- **EduPage location:** Specification → "Bell times / Periods…"
...
- **Wire shape:** `periods` cdef (verbatim from `EDUPAGE_OPS_DEEP_DIVE_R2.md` §3.2):
  ```
...
- **Source:** `EDUPAGE_FEATURE_MAP_2026-05-03.md` §1a, 1a-i, 1a-ii; `EDUPAGE_OPS_DEEP_DIVE_R2.md` §3.2
...
- **EduPage location:** Periods dialog → "Add break that will be printed between lessons"
...
- **Wire shape:** verbatim from `EDUPAGE_OPS_DEEP_DIVE_R2.md` §3.3:
  ```
...
- **Source:** `EDUPAGE_FEATURE_MAP_2026-05-03.md` §1a-i-break; `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` SPEC-02
...
- **EduPage location:** Specification → "Days…" (also reached from School step's "Rename days" link)
...
- **Wire shape:** `daysdefs.cdefs: [name, typ, val, vals, short]` (verbatim from `EDUPAGE_OPS_DEEP_DIVE_R2.md` §5).
...
- **Source:** `EDUPAGE_FEATURE_MAP_2026-05-03.md` §1g, 1g-i, 1g-ii, 1g-iii; `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` SPEC-03
...
- **EduPage location:** Specification → "Weeks…"
...
- **Source:** `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` SPEC-03; `EDUPAGE_OPS_DEEP_DIVE_R2.md` §5
- **Priority:** P1 (used by schools with bi-weekly cycles)

### 2.5 Terms dialog — TermPattern entity
- **EduPage location:** Specification → "Terms…"
...
- **Source:** `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` SPEC-03
- **Priority:** P1

### 2.6 Multi-term/multi-week wizard (School step toggle)
- **EduPage location:** School step → "I want to create multi term or multi-week timetable" checkbox
...
- **Source:** `EDUPAGE_FEATURE_MAP_2026-05-03.md` §1
- **Priority:** P1

### 2.7 Buildings entity
- **EduPage location:** Specification → "Buildings…"
...
- **Source:** `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` SPEC §5; `EDUPAGE_RE_GAPS_2026-05-03.md` §1
- **Priority:** P1

### 2.8 Holidays entity
- **EduPage location:** Specification → "Holidays…"
- **Chronexa status:** ⛔ menu item exists, fires `app:open-entity {kind:"holidays"}` — no router handler, no model. EduPage's wire schema doesn't have a dedicated `holidays` table in the 27-entity census either (`EDUPAGE_OPS_DEEP_DIVE_R2.md` §5) — this is a Chronexa-invented menu item.
- **Priority:** P2

### 2.9 School settings dialog
- **EduPage location:** Specification → "School settings…" / wizard step 1
...
- **Wire shape:** `globals` cdef — `name, year, tt_year, settings, customfields, tt_datefrom, tt_num, edupage_year, demofile, tt_name, tt_version, modified, unregistered` (verbatim `EDUPAGE_OPS_DEEP_DIVE_R2.md` §4).
...
- **EduPage location:** Specification → "List of inputted constraints" (also Timetable ribbon → same button)
- **Wire shape:** `runTTVerification` mode `"listconstraints"` (verbatim `EDUPAGE_OPS_DEEP_DIVE_R2.md` §2.6).
...
- **Source:** `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` Timetable §6
- **Priority:** P1

### 2.11 Reports dialog
- **EduPage location:** Specification → "Reports…"
- **What it does:** Per `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §E — jQuery UI dialog (~600×630) listing **24 report templates** (one row per template), with "Modify structure" per row → opens 4-tab subdialog.
- **Wire shape:** `ttreports` table fetch via `ttuidocDBIAccessor` (verbatim 40+ field schema in `EDUPAGE_RE_GAPS_2026-05-03.md` §"ttreports").
...
- **Source:** `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §E
- **Priority:** P1
...
Sources: `EDUPAGE_FEATURE_MAP_WIZARD_2_5_R5.md` §§2/3/4 (Subjects/Classes/Classrooms), `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §§6/7 (Teachers, Lessons), `EDUPAGE_FEATURE_MAP_PER_ENTITY_ACTIONS_R8.md` (Time-off / Constraints / Divisions matrix).

### 3.1 Subject — missing fields
| Field | EduPage label | Chronexa | Source |
|---|---|---|---|
| `picture_url` | "Picture" | ⛔ no field on entity. Card prints can't surface subject pictures. | `EDUPAGE_FEATURE_MAP_WIZARD_2_5_R5.md` §2b |
...
| Field | EduPage label | Chronexa | Source |
|---|---|---|---|
| `classroomids` plural (multi home-room) | "Home classroom" multi-select | 🟨 Chronexa has `classroomIds` array on class (`classes.js:13`) — verify XML round-trip | `EDUPAGE_FEATURE_MAP_WIZARD_2_5_R5.md` §3b |
...
| `edupageid` | "edupageid" sync key | ⛔ | §3b |
...
- **EduPage label:** "Class teacher must teach this class in specific time every day"
...
- **Wire shape:** verbatim sample from `EDUPAGE_FEATURE_MAP_WIZARD_2_5_R5.md` §3b-constraints for class I-A:
  ```json
...
- **Source:** `EDUPAGE_FEATURE_MAP_WIZARD_2_5_R5.md` §3b-constraints; `EDUPAGE_FEATURE_MAP_PER_ENTITY_ACTIONS_R8.md` §2c "Class.constraints"
...
- **EduPage label:** "Education block" (enum: 0=Disabled / 1=Manual / 2=Auto)
...
- **EduPage labels:** "Education block - min - from / till", "Education block - max - from / till"
...
- **EduPage labels:** "Allow arrival on second lesson." / "The groups of students have to finish the day in the same time."
...
- **EduPage labels:** "Lunch - from" / "Lunch - till" (tokens: `d`=school default, `*`=any, int=period)
...
| Field | EduPage label | Chronexa | Source |
|---|---|---|---|
| `buildingid` | "Building" FK | ⛔ no Building entity (§2.7) | `EDUPAGE_FEATURE_MAP_WIZARD_2_5_R5.md` §4b |
...
| Field | EduPage label | Chronexa | Source |
|---|---|---|---|
| `gender` | "Gender" dropdown | ⛔ | `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §6.1 row 9 |
...
- **EduPage labels:** "Supervisions: Min Count / Max Count / Min Minutes / Max Minutes"
...
- **Source:** `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §6.3 rows 8-11; §9.4
- **Priority:** P1

### 3.12 Teacher constraints — "Set for more" link
- **EduPage UX:** Every constraint row except supervisions has a "Set for more" link to bulk-apply to N other teachers.
- **Chronexa status:** ✅ shipped (`teacher_constraints_dialog.js:127`).
- **Priority:** — (parity)

### 3.13 Lesson — `classroomidss` (per-card classroom variation)
- **EduPage wire:** `classroomidss` — **array-of-arrays**, one inner array per card of the lesson. If `count=6`, six inner arrays.
...
- **Source:** `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §7.6
- **Priority:** P0

### 3.14 Lesson — `metaclassroomidss_expanded` (server-side derivation)
- **EduPage wire:** Server computes the expanded classroom set from the Home/Shared/Teacher's/Subject's shortcuts and stores it as `metaclassroomidss_expanded`. The solver consumes this expanded list, not the raw shortcuts.
...
- **Source:** `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §7.1 row 12
- **Priority:** P0 (without this, "Home classroom" shortcut doesn't constrain placement)

### 3.15 Lesson — `bell` FK per-lesson override
- **EduPage label:** "Bells: automatically" dropdown at bottom of Lesson dialog
- **Chronexa status:** ⛔ no field on lesson model.
- **Source:** `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §7.1 row 15
- **Priority:** P1

### 3.16 Lesson — `seminargroup` (string-keyed cross-class elective)
- **EduPage:** `lessons.seminargroup` (string) joins to `studentsubjects.seminargroup` for cross-class electives. Same-string lessons run in parallel.
- **Chronexa status:** ⛔ no field. No `students` or `studentsubjects` model.
- **Source:** `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §9.3
- **Priority:** P2 (rare at primary/middle school; matters for senior secondary electives)

### 3.17 Lesson — `texts` (notes)
- **EduPage label:** "Notes" / annotation text field
- **Chronexa status:** ⛔
- **Priority:** P2
...
- **Source:** `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §7.1 rows 17-20
- **Priority:** P1 (`maxstudents`/capacity), P2 (rest)

### 3.19 Lesson — daysdefid / weeksdefid / termsdefid FK
- **EduPage wire:** Lessons FK to DayPattern / WeekPattern / TermPattern (covered above §2.3-2.5).
...
- **EduPage UX:** Per-lesson Copy-to dialog with 3 vertical icon buttons: To another teacher / To another class / Duplicate.
...
- **Source:** `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §7.4
- **Priority:** P2

### 3.21 Lesson — "Change" batch-edit dialog (wizard-only)
- **EduPage:** Wizard Lessons step has a "Change" button that opens a batch-modify dialog with 11 editable parameter rows (Subject, Teachers, Term, Week, Day of week, Count, Length, Capacity, etc.). Each row expands to a picker; the chosen value rewrites that one field on all selected lessons.
...
- **Source:** `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §7.5
- **Priority:** P1

### 3.22 Per-entity Lessons sub-view (filtered list)
- **EduPage UX:** Each entity (Subject/Class/Teacher/Classroom) has a "Lessons" sub-action button that opens a filtered list of lessons participating in that entity.
...
- **Source:** `EDUPAGE_FEATURE_MAP_PER_ENTITY_ACTIONS_R8.md` §4
- **Priority:** P2

### 3.23 Subjects-of-class drilldown
- **EduPage UX:** Class-perspective grid with column header switched to "Subject" — gives "what subjects does this class take" with "+" button to add a missing subject.
- **Chronexa status:** ⛔
- **Source:** `EDUPAGE_FEATURE_MAP_WIZARD_2_5_R5.md` §3c-v
- **Priority:** P2

### 3.24 Edit-dialog `< >` cycle arrows
- **EduPage UX:** Every edit dialog has `<` `>` arrows to step through sibling rows without close/reopen.
- **Chronexa status:** ✅ shipped (`teachers.js:122`, `siblingRows` + `onNavigate` in `dialog_shell.js`).
- **Priority:** — (parity)

### 3.25 Custom fields (any entity)
- **EduPage:** Most entity rows expose a `customfields` subarray (`{field, value}` pairs) plus a per-school "Custom fields" dictionary on `globals`.
- **Chronexa status:** ⛔ no UI on any entity; no globals dictionary.
- **Priority:** P2

### 3.26 Color-a-card-by axis (Subject / Teacher / Class / Classroom)
- **EduPage:** "Color a card by…" dropdown in Print preview / per `ttreports.cardcolortable1`/`cardcolortable2`/`cardcolorpos`. Default = Subject color; can re-bind to Teacher / Class / Classroom.
- **Chronexa status:** ⛔ no axis switcher. `grid_canvas.js:300-318` always hashes the subject abbreviation into a hue. The XML loaded for the GDGPSD demo has teacher colors only — Bug #4 in `EDUPAGE_E3_COLOR_TAXONOMY_2026-05-03.md` §a applies here.
- **Source:** `EDUPAGE_E3_COLOR_TAXONOMY_2026-05-03.md` §a, §d
- **Priority:** P1

### 3.27 Subject color seeding from import
- **EduPage:** When XML carries `<subject color>`, that's the source-of-truth.
- **Chronexa status:** 🟨 `parse_asc_xml.js` may or may not read it (not verified); even if read, no color-axis switcher (§3.26).
- **Source:** `EDUPAGE_E3_COLOR_TAXONOMY_2026-05-03.md` §c (Swift parser had the same gap — Chronexa Web likely inherits it)
- **Priority:** P1
...
Source: `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §10. Chronexa: `js/ui/entities/relations.js` (683 lines) + `js/solver/constraints.js`.
...
- **Source:** `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §10.2
...
- **EduPage:** Picker that restricts which weeks/terms/days the relation applies to.
- **Chronexa status:** ⛔ no UI.
- **Priority:** P2
...
- **Source:** `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §10.2 (note: "n_2 / n_3 / n_15 — GAP")
- **Priority:** P2 (defer until decoded by future instrumented session)

### 4.8 `a_*` 84-code round-trip
- **EduPage:** 84 additional `a_*` codes (e.g. `a_0` "Max days per week", `a_10` "Max periods per day", `a_15` "Max cards on one period") stored on the same `cardrelationships` table, round-tripped but not editable in EduPage's web UI either.
- **Chronexa status:** ⛔ not in relations.js' `TYP_CATALOGUE` (limited to 15 n_*). XML round-trip status unverified.
- **Source:** `EDUPAGE_FEATURE_MAP_PER_ENTITY_ACTIONS_R8.md` §2b
- **Priority:** P2 (data preservation issue; flag for XML round-trip test)

### 4.9 Per-entity scope filter on Relations
- **EduPage UX:** Subject's Constraints button opens a filtered Relations view (only rows with `subjectids` containing this subject).
- **Chronexa status:** ⛔ subjects/classes/teachers/classrooms don't filter the Relations list.
- **Source:** `EDUPAGE_FEATURE_MAP_PER_ENTITY_ACTIONS_R8.md` §2; "Subject Constraints" is the EduPage user-visible name.
- **Priority:** P1

### 4.10 `globals.constraints` Tier-1 (8 school-wide fields)
- **EduPage labels (verbatim from `EDUPAGE_OPS_DEEP_DIVE_R2.md` §4):**
...
Source: `EDUPAGE_E2_GRID_INTERACTIONS_2026-05-03.md`, `EDUPAGE_DRAG_UX_R9.md`. Chronexa: `js/ui/editor/grid_canvas.js`, `card_in_hand.js`, `placement_validator.js`, `constraint_explainer.js`.

### 5.1 Single-click pickup / place
- **EduPage:** `c=true` flag flips on `mousedown`; `mouseup` anywhere places. No HTML5 `dragstart`.
...
- **EduPage:** Translucent ghost `position:fixed` div anchored to cursor via `transform: translate()` per `mousemove`.
...
- **Source:** `EDUPAGE_DRAG_UX_R9.md` §2
- **Priority:** — likely parity

### 5.3 Heatmap painted on pickup (oc/hc/sc 3-tier)
- **EduPage CSS classes:** `vpolicko volne` (free) / `vpolicko obsadene` (occupied) / `vpolicko cursor volne` / `vpolicko first obsadene` / `vpolicko break volne` etc. Five-tier heatmap with break-row variants.
- **Chronexa status:** 🟨 partial. `placement_validator.js:23` returns `{validity:"green"|"amber"|"red", reasons}` — 3-tier green/amber/red, missing the break-row class variants and the oc/hc/sc constraint-type codes from EduPage's testPing pings.
- **Source:** `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §F
- **Priority:** P1

### 5.4 Right-click on a placed card — 14-item context menu
- **EduPage menu (verbatim from `EDUPAGE_E2_GRID_INTERACTIONS_2026-05-03.md` §a):**
  - Header pin
  - Remove (= pickup)
  - Lock / Unlock
  - Edit lesson
...
- **Source:** `EDUPAGE_E2_GRID_INTERACTIONS_2026-05-03.md` §a
- **Priority:** P0

### 5.5 Right-click on EMPTY cell — 3-item menu
- **EduPage menu:** "Place lesson here ▶" (top-N unplaced for this row's class) + "Time off here" + "Open lessons for class"
- **Chronexa status:** ⛔
- **Source:** `EDUPAGE_E2_GRID_INTERACTIONS_2026-05-03.md` §a
- **Priority:** P1

### 5.6 Right-click on DAY-header / PERIOD-header
- **EduPage menu:** Day-header → column-time-off menu. Period-header → row-time-off menu.
- **Chronexa status:** ⛔
- **Priority:** P2

### 5.7 Double-click on placed card — opens Lesson-info modal
- **Chronexa status:** ⛔ (grid_canvas.js only handles `mousedown`, no `dblclick`).
- **Source:** `EDUPAGE_E2_GRID_INTERACTIONS_2026-05-03.md` §a row "Double-click"
- **Priority:** P1

### 5.8 Click a column / row header to highlight
- **EduPage:** Day-label click adds yellow tint to that column.
- **Chronexa status:** ⛔
- **Priority:** P2

### 5.9 Locked-card visual (`cards.locked`)
- **EduPage:** Padlock icon overlay on locked cards; solver does not move them.
- **Chronexa status:** 🟨 partial. `grid_canvas.js:197` adds `locked` CSS class when `lesson.fixedDay !== null` — but the field is `lesson.fixedDay`, not `card.locked`. EduPage models lock at the card level; Chronexa at the lesson level → can't lock individual placements without locking the whole lesson.
- **Source:** `EDUPAGE_OPS_DEEP_DIVE_R2.md` §2.2 (`cards.locked` field)
- **Priority:** P1

### 5.10 Held-card preview lifts source slot empty
- **EduPage:** Source slot empties with faint dashed outline.
- **Chronexa status:** 🟨 source slot empties (`grid_canvas.js:244-252`); no dashed outline.
- **Priority:** P2

### 5.11 Pending-cards rail (`.pending-area`)
- **EduPage:** Bottom-strip rail of unplaced cards. 5-filter chips (school/class/teacher/subject/classroom) above the rail toggle which entity-type's unplaced items show.
- **Chronexa status:** 🟨 `pending_strip.js:164` ships the rail; no filter chips.
- **Source:** `EDUPAGE_E4_EDITOR_TOOLBAR_2026-05-03.md` §b
- **Priority:** P1

### 5.12 Verification panel — bottom-docked tray with tree-expand
- **EduPage:** `.kontrola > .chyby > .dt-container > .asc-dt > table` — always-visible 180-px tall bottom tray with tree-plus drill-down per constraint. Server-side grouping → "8x — Two cards on same position" then expand to per-entity rows.
- **Chronexa status:** 🟨 partial. `js/ui/components/verification.js` ships a bottom-docked drawer with sections (Teachers/Classes/Rooms) and per-row hard/soft level. **Missing: tree-expand, server-side grouping into "Nx" rollups, count column.** Per `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §D the Chronexa side is NSAlert-style sheet rather than docked tray.
- **Code anchor:** `js/ui/components/verification.js:128-180`
- **Source:** `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §D
- **Priority:** P1

### 5.13 Halo paint on grid cells (`m_pVysvietZle` bitstring)
- **EduPage:** Verification result includes per-error `m_pVysvietZle` field — 6 strings of 9 chars each (`"011100110"` per day Mo-Sa, per period). Clicking the error in the panel paints red haloes on the matching grid cells.
- **Wire shape (verbatim from `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §D):**
  ```json
  "m_pVysvietZle": [[[
...
- **EduPage:** `Timetable > Statistics` opens a ~900×510 jQuery UI dialog with:
...
- **Source:** `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §G
- **Priority:** P1

### 5.15 Advisor dialog (`runTTAdvisor`)
- **EduPage:** `Timetable > Advisor` opens a 2-tab dialog ("Critical problems" / "Suggestions" with count badges). Per-task: Ignore / Help / one button per fix.
- **Wire shape (verbatim from `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §H):**
  ```
...
- **Source:** `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §H
- **Priority:** P1

### 5.16 Card hover tooltip (constraint explainer)
- **Chronexa status:** ✅ **Chronexa-novel feature.** `constraint_explainer.js` (322 lines) shows plain-English "why is this card red" — EduPage has CSS `:hover` glow only. This is ahead of EduPage.
- **Source:** `EDUPAGE_E2_GRID_INTERACTIONS_2026-05-03.md` §d (table: "Hover tooltip — Chronexa AHEAD")
...
- **EduPage:** Pre-flight dialog with Test/Generate mode + Complexity {Normal, Large, Huge} + Conditions {Draft, Allow relaxation, Strict}.
...
- **EduPage generatorPing payload (verbatim from `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §B):**
  ```json
  {"r":{"generating":{
     "p1":0.0055, "p2":0,
     "m_nRychlost":83976,
...
- **Source:** `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §B
- **Priority:** P1

### 6.3 Generator final result — `chyby[]` attached
- **EduPage final payload:**
  ```json
  {"r":{"result":{
...
- **EduPage:** Test always starts with: *"Unlocked cards will be removed prior to testing the timetable. Are you sure you want to go on?"* `[OK][Cancel]`
- **Chronexa status:** ⛔ no confirm. `test_dialog.js` runs immediately on Test click.
- **Source:** `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §C
- **Priority:** P1

### 6.5 Test — streaming `list[]` with oc/hc/sc codes
- **EduPage testPing response shape:**
  ```json
  "list":[
    {"text":"Global - ", "type":"oc"},
...
- **Source:** `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §C; `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §8.2
- **Priority:** P0 (the streaming pass/fail list is the central Test UX)

### 6.6 Test — per-fault 6-button dialog
- **EduPage buttons:** "CHECK and FIX this problem · Test this item AGAIN · SKIP this and continue testing · Test with RELAXATION · HELP. Show me HELP. · END test · Cancel"
- **Chronexa status:** ⛔
- **Source:** `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §C
- **Priority:** P1

### 6.7 Verification — `runTTVerification` 30KB error list with grouping
- **EduPage per-error schema (verbatim from `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §D):**
  ```json
  {
    "m_pKde": ["teachers","*99"],
...
- **EduPage:** `Timetable > Improve` — iterative solver that re-optimizes the current solution while preserving locked cards. Distinct from full Generate.
- **Wire:** `generatorStart` with improve-mode flag (same RPC).
- **Chronexa status:** ⛔ no Improve button. Generate from scratch only.
- **Source:** `EDUPAGE_E4_EDITOR_TOOLBAR_2026-05-03.md` §a Timetable row; `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §I
- **Priority:** P1

### 6.9 Parameters dialog (solver tuning)
- **EduPage:** `Timetable > Parameters` — global solver parameters.
- **Chronexa status:** ⛔
- **Source:** `EDUPAGE_E4_EDITOR_TOOLBAR_2026-05-03.md` §a Timetable
- **Priority:** P2

### 6.10 Assign classrooms (bulk solver)
- **EduPage:** `Timetable > Assign classrooms` — automated room assignment over an already-scheduled timetable.
- **Chronexa status:** ⛔
- **Source:** `EDUPAGE_E4_EDITOR_TOOLBAR_2026-05-03.md` §a Timetable
- **Priority:** P2

### 6.11 Lock / Unlock (bulk)
- **EduPage:** `Timetable > Lock` / `Unlock` — toggle `cards.locked` across all placed cards.
- **Chronexa status:** ⛔ no per-card lock data flow (§5.9).
- **Priority:** P1

### 6.12 Remove timetable (destructive wipe)
- **EduPage:** `Timetable > Remove timetable` — wipe all placements, keep specification entities.
- **Chronexa status:** ⛔
- **Priority:** P2
...
- **What EduPage's solver enforces (from the relations + globals + per-entity constraints):**
...
- **Source:** `js/solver/constraints.js:74-134`; `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §I; `EDUPAGE_FEATURE_MAP_PER_ENTITY_ACTIONS_R8.md` §2c
- **Priority:** P0 across the board (the solver gap is what makes the whole product feel "30 % done")

### 6.14 Time-off `?` conditional state
- **EduPage:** 3-state matrix — `1` available / `?` conditional (soft block, counted against `maxOnConditional` cap) / `0` not available (hard block).
...
- **Source:** `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §6.2; `EDUPAGE_FEATURE_MAP_PER_ENTITY_ACTIONS_R8.md` §1a-d
- **Priority:** P1
...
Source: `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` "Files menu — Print sub-flow" + `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §A. Chronexa: `js/ui/print_preview/print_preview.js`.

### 7.1 Print Preview ribbon swap (12 controls)
- **EduPage:** Click "Print preview" → entire ribbon swaps into preview mode with 12 buttons: Previous page / Next page / Print / **Select your report** dropdown / Filter / Global settings / Modify structure / Extra columns/rows / Style / Sizes/widths / Design / Colors / Close preview.
...
- **Source:** `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §A
- **Priority:** P1

### 7.2 24 report templates (Chronexa ships 5)
- **EduPage report names (verbatim from `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §A):**
...
- **EduPage (verbatim from `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` Files §Print sub-flow detail):**
...
- **EduPage:** Per-report Modify structure → 4 panels:
...
- **Chronexa status:** ⛔
- **Source:** `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §A; `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` Files
- **Priority:** P1

### 7.5 Sizes / Design / Colors subdialogs
- **EduPage Sizes:** Landscape / Normal · Number of copies · Add classroom timetable
...
- **What it does:** Per `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §A, EduPage renders Monday correctly as leftmost data column. Chronexa was found to drop Monday.
...
- **Source:** `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §A "Bug B confirmed Chronexa-side"
- **Priority:** P0 (visible rendering bug)

### 7.7 Right-click on rendered preview → "Style" panel
- **EduPage:** Context menu on rendered preview cells lets user restyle.
- **Chronexa status:** ⛔
- **Priority:** P2

### 7.8 Page counter ("Page 1 / 33")
- **EduPage:** Live page counter.
- **Chronexa status:** ✅ shipped (`print_preview.js:54, 136`).
- **Priority:** — (parity)

### 7.9 `getDesignData` template fetch
- **EduPage wire (verbatim from `EDUPAGE_OPS_DEEP_DIVE_R2.md` §9):**
  ```
...
- **EduPage:** Returns `/photos/skin/logo/...jpeg` for print headers.
...
Source: `EDUPAGE_E5_EDIT_UNDO_REDO_2026-05-03.md`, `EDUPAGE_OPS_DEEP_DIVE_R2.md` §6-7. Chronexa: `js/ui/io/snapshot.js`, `js/ui/ribbon/undo_redo.js`, `js/ui/audit` (mentioned in source).

### 8.1 Undo / Redo
- **EduPage wire:** `ttuidocUndo` RPC, args `[null, dbi, isRedo]`. Server-side stack (`canundo`/`canredo` polled via globals).
...
- **Source:** `EDUPAGE_E5_EDIT_UNDO_REDO_2026-05-03.md` §a
- **Priority:** — (Chronexa local undo is fine for single-user)

### 8.2 Snapshot save (`ttuidocSaveTT` snapshot_only mode)
- **EduPage wire:** `{"ss_note":"...", "snapshot_only":true}` creates a versioned `tt_snapshots` row.
- **Chronexa status:** ✅ shipped (`snapshot.js:84-97`). localStorage-backed, gzipped via pako.
- **Priority:** — (parity)

### 8.3 Version-history dialog (per-table diff)
- **EduPage wire:** `calcTtSnapshotVersionsDiffs` returns per-table {count, added, removed, updated} + `otherChangedTables` (verbatim §1.16).
...
- **Source:** `EDUPAGE_OPS_DEEP_DIVE_R2.md` §7
- **Priority:** P2

### 8.4 Save-as dialog with existing-TT list
- **EduPage UX:** "Edupage — Save as…" modal with scrollable list of existing timetables (Name / School year / Date uploaded), Name + Note input, OK / Cancel.
- **Chronexa status:** 🟨 partial. `snapshot.js:159-171` has Name prompt only — no list, no Note field, no school-year.
- **Source:** `EDUPAGE_E1_FILE_MENU_2026-05-03.md` §d
- **Priority:** P2

### 8.5 Multiple-document model (`tt_docs.apps`)
- **EduPage:** Multiple named timetable documents per school, each with its own version history.
- **Chronexa status:** ⛔ Chronexa has one active doc + localStorage snapshots. No multi-doc picker.
- **Source:** `EDUPAGE_COLLAB_UX_R10.md` §1
- **Priority:** P2

### 8.6 Demo files toggle
- **EduPage:** `globals.demofile` checkbox surfaces demo TTs in the picker.
...
Source: `EDUPAGE_COLLAB_UX_R10.md`. Chronexa is single-user / local-only — most of this is N/A for the current product, but listed for completeness.

### 9.1 `tt_docs.apps` presence subtable
- **EduPage wire shape (verbatim §1):**
  ```json
...
- **EduPage:** Top-right counter ("Me (2)") of active collaborators. Click → user list.
- **Chronexa status:** ⛔
- **Priority:** P2

### 9.3 `pollChangeEvents` long-poll heartbeat
- **EduPage wire:** Form-encoded POST every ~6s with topic keys.
- **Chronexa status:** ⛔
- **Priority:** P2

### 9.4 `__gsh` CSRF token
- **EduPage:** Per-session 8-hex `__gsh` token in every authenticated POST.
...
- **What it does:** Per Chronexa-ROADMAP, "full parity with the school's Apps Script substitution-planner". Not EduPage-derived — EduPage's substitution surface is a separate `bundle_subst.min.js` module and was not deep-dived in the R-series docs.
- **Chronexa status:** ✅ shipped per ROADMAP. Verified file structure: 4-tab flow (Absent teachers → Class-wise → Teacher-wise → Print memo) at `js/ui/substitution/main.js:104-122`. Not benchmarked against EduPage here.
...
Source: `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` View menu. Chronexa: `js/ui/ribbon/menus/view_menu.js`.

### 11.1 Perspective switcher (Classes / Teachers / Classrooms / Subjects / Students / Lesson grid)
- **EduPage:** 7 perspective rows in `ttviews` table (typ 2-9). Students (6) and Room supervision (8) hidden by default.
...
- **Source:** `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` View
- **Priority:** P1

### 11.2 Custom saved views ("Add timetable" / "Define")
- **EduPage:** User can add named saved views with entity filters via `ttviews` add/update RPCs.
- **Chronexa status:** ⛔ no custom-view UI. `ttviews.js` (119 lines) orphan CRUD shell.
- **Source:** `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` View §8
- **Priority:** P2

### 11.3 Lesson grid (flat lessons table)
- **EduPage:** Flat tabular view of all lessons via View menu.
...
- **EduPage i18n:** "Resize pending cards area"
- **Chronexa status:** ⛔ no resize handle on `pending-strip-root`.
- **Source:** `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` View §10
- **Priority:** P2

### 11.5 "Change axis used for terms/weeks"
- **EduPage i18n:** Swaps rows-vs-cols dimension for terms/weeks.
...
- **EduPage:** Toggle the left view-mode tab strip.
- **Chronexa status:** ⛔
- **Priority:** P2

### 11.8 Related timetables
- **EduPage:** Cross-school sub-timetable manager (`related_32.svg`).
- **Chronexa status:** ⛔ (multi-school out of scope)
- **Priority:** P2

### 11.9 Individual timetables view
- **EduPage:** Per-teacher / per-class print-style preview view.
- **Chronexa status:** ⛔
- **Priority:** P2

### 11.10 "Quick add"
- **EduPage:** Quick-add lesson/teacher/class popup from View menu.
- **Chronexa status:** ⛔
- **Priority:** P2
...
Source: `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` Options menu. Chronexa: `js/ui/ribbon/menus/options_menu.js`.

### 12.1 `globals.settings` 23-field schema
- **EduPage fields (verbatim from `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` Options):**
...
- **Source:** `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` OPT-01
- **Priority:** P1 (the actual settings UX gap)

### 12.2 Supervision criteria (`m_DozoryKriteria` 14-field subobject)
- **EduPage:** Sub-dialog controlling how duty/supervision assignments are made.
...
- **EduPage:** Changes lesson-input UI from period counts to time amounts.
- **Chronexa status:** ⛔
- **Priority:** P2

### 12.4 Name format (Last First / First Last / Abbrev)
- **EduPage:** `name_format` combo.
- **Chronexa status:** ⛔
- **Priority:** P2

### 12.5 Time format 12h/24h
- **EduPage:** `m_nTimeFormat`.
- **Chronexa status:** ⛔
- **Priority:** P2

### 12.6 First day of week
- **EduPage:** `m_nPrvyDen` (Monday=0 / Sunday=6).
- **Chronexa status:** 🟨 hard-coded to `DAY_LABELS_EN = ["Mon",...]` (`grid_canvas.js:11`).
- **Priority:** P2

### 12.7 Show day as number
- **EduPage:** `m_bPrintDayAsNumber` — affects all UI labels.
- **Chronexa status:** ⛔
- **Priority:** P2
...
- **EduPage:** External-URL launchers.
...
- **EduPage:** Per-wizard-step "Open online help" link.
- **Chronexa status:** ⛔
- **Priority:** P2

### 13.3 AI menu (4 items, all stubs)
- **EduPage items (per `EDUPAGE_FEATURE_MAP_TOOLBAR_R7.md` AI):** Auto-fill empty cells / Cleanup last card move / Lock all placed cells / Suggest placements
...
Source: `EDUPAGE_E5_EDIT_UNDO_REDO_2026-05-03.md` §c.

| Combo | EduPage action | Chronexa | Notes |
|---|---|---|---|
| Ctrl+Z / Cmd+Z | Undo | ✅ shipped (per ROADMAP, help_menu.js shortcuts modal) | Chronexa supports Cmd (Mac canonical), EduPage Ctrl only |
| Ctrl+Y / Cmd+Shift+Z | Redo | ✅ shipped | — |
| `+` / `-` / `/` | Zoom in / out / reset | ⛔ (view_menu has 5 fixed levels) | P2 |
| `Arrow{Up,Down}` / PageUp/Dn | Scroll grid | ⛔ | P2 |
| `Space` | Open verification panel | ⛔ | P1 — `Space` is the natural EduPage way to surface conflicts |
...
Source: `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §9.

### 15.1 `students` entity (individual student CRUD)
- **EduPage fields:** `classid, timeoff, name, short, firstname, lastname, groupids, customfields`
...
- **EduPage fields:** `studentid, subjectid, seminargroup, importance, locked`
- **Chronexa status:** ⛔
- **Source:** §9.2
- **Priority:** P2

### 15.3 `classroomsupervisions` entity (the solver-relevant one)
- **EduPage fields:** `classroomid, teacherid, term, week, day, period, break, locked`
...
- **Chronexa status:** 🟨 `js/ui/entities/classroomsupervisions.js` (171 lines) is a CRUD shell. `solver/constraints.js:180-199` has `CKritSluzba` function that scores double-bookings — but it's not wired into the main `canPlace` loop. Per `EDUPAGE_FEATURE_MAP_WIZARD_6_8_R6.md` §9.4: "**P0 if user has supervisions**".
...
- **EduPage fields:** `short, name, subjectids, constraints`
...
- **EduPage fields:** `name, classid, entireclass, ascttdivision, okgroup, color`
...
Source: `EDUPAGE_FEATURE_MAP_PER_ENTITY_ACTIONS_R8.md` §3.

### 16.1 Default + alternative divisions per class
- **EduPage:** Class has implicit "Entire class" division (`divisiontag=0`, `entireclass=true`) + 0..N alternative divisions (`divisiontag=1..7`) each partitioning the class.
...
- **EduPage wire (verbatim `EDUPAGE_FEATURE_MAP_PER_ENTITY_ACTIONS_R8.md` §3c):**
  ```
...
- **EduPage:** Apply identical division across multiple classes.
- **Chronexa status:** ⛔ no "Apply division pattern to N classes" batch UI.
- **Source:** `EDUPAGE_FEATURE_MAP_PER_ENTITY_ACTIONS_R8.md` §3c
- **Priority:** P2

### 16.4 `students_count` per division group
- **EduPage:** `{"name":"mu", "students_count":15}` for split-level pair with explicit head counts.
...
Source: `EDUPAGE_RE_GAPS_2026-05-03.md`, `EDUPAGE_OPS_DEEP_DIVE_R2.md`.
...
Ranking heuristic: `severity (P0/P1/P2 = 3/2/1) × user-visibility (do they see it on first try? 3/2/1) × proximity-to-blocking-MVP (does it block a documented EduPage flow? 3/2/1)`. Tie-breaker: solver-side gaps beat UI-side gaps because UI without solver enforcement = "30 % done" trap.
...
| 4 | **Per-fault Test dialog with streaming `oc/hc/sc` `list[]`** | new `test_dialog.js` body | Test today is binary; EduPage shows pass/fail per constraint in real time. | §6.5, §6.6 |
...
| 8 | **Right-click context menu on placed cards (14 items)** | `js/ui/editor/grid_canvas.js` | The most-used UX shortcut in EduPage's editor. Chronexa has zero context menus on cards. | §5.4 |
...
| 13 | **Bug B — print preview Monday drop** | `js/ui/print_preview/print_preview.js` | Visible rendering bug per `EDUPAGE_VS_CHRONEXA_GAP_MAP_2026-05-04.md` §A. | §7.6 |
...
| 20 | **Compare-with-last-saved (per-table diff)** | `snapshot.js` extension | Menu item exists; no listener. Per-table {added/removed/updated} is the EduPage shape, not entity-count length. | §1.16, §8.3 |
...
| 30 | **Pending-strip filter chips (5 entity types)** | `pending_strip.js` | EduPage's `.rad_icons` row of 5 icons (school/class/teacher/subject/classroom) filters the rail. | §5.11 |

---

## 20. What's NOT in this audit

- aSc XML round-trip fidelity per field (separate audit needed — many lesson/entity fields persist via XML but not verified post-roundtrip).
...
- Substitution module (§10) — out of EduPage scope.
