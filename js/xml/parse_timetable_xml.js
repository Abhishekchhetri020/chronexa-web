 ...
 */
const _global = typeof window !== "undefined" ? window : (typeof globalThis !== "undefined" ? globalThis : global);
_global.parseTimetableXml = (function () {
  "use strict";
  ...
  function parseText(text, sourceName) {
    ...
    xml.querySelectorAll("lessons > lesson").forEach(l => {
      ...
      const obj = {
        ...
        periodsPerCard: parseInt(attr(l, "periodspercard"), 10) || 1,
        lessonLength: parseInt(attr(l, "periodspercard"), 10) || 1,
    ...
    const cleanLessons = lessons.map(l => ({
      ...
      periodsPerCard: l.periodsPerCard,
      lessonLength: l.lessonLength,
...
export const parseTimetableXml = _global.parseTimetableXml;
