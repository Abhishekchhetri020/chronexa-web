  ...
  function open() {
    ...
    D.buildEditSheet({
      ...
      fields: [
        ...
        field("Section: Custom fields"),
        field("Entity custom fields:", actionBtn("Manage custom fields…", () => {
          if (window.CustomFields) window.CustomFields.open();
        })),
      ],
      onSave: () => {
...
export const SchoolSettings = window.SchoolSettings;
