    ...
    build() {
      return [
        ...
        { icon: "⬇",  label: "Import", sub: [
          { icon: "📄", label: "aSc Timetables XML",  run: () => fire("app:import-asc-xml") },
          { icon: "🌐", label: "EduPage — Basic school data",  soon: true },
          { icon: "🔔", label: "EduPage — Bell times",          soon: true },
          { icon: "📋", label: "Import from Clipboard",         soon: true },
          { icon: "🗓",  label: "EduPage — Timetable",           soon: true },
          { icon: "🪐", label: "Jupiter (Stirlingschools)",     soon: true },
        ]},
        { icon: "⬆",  label: "Export", disabled: !has(), sub: [
          { icon: "📦", label: "aSc Timetables (*.roz)",        soon: true },
          { icon: "📄", label: "aSc Timetables XML",            run: () => fire("app:export-asc-xml") },
          { sep: true },
