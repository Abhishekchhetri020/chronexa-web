...
(function (global) {
  ...
  const NAV = [
    ...
    { svg: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>', label: "Export…",     on: () => fire("app:export-dialog") },
    // Publish (W2-3): the ribbon's Files → Export menu is hidden inside the
    // editor shell, so the shareable editions need this sidebar entry too.
    { svg: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.6" y1="10.5" x2="15.4" y2="6.5"/><line x1="8.6" y1="13.5" x2="15.4" y2="17.5"/></svg>', label: "Publish timetable\u2026", on: () => fire("app:publish-timetable") },
    ...
    // Automatic backups + version history (W3-1): the ribbon's Files menu is
    // hidden inside the editor shell, so the rolling backups need this entry too.
    { svg: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v5h5"/><path d="M3.05 13A9 9 0 1 0 6 5.3L3 8"/><path d="M12 7v5l4 2"/></svg>', label: "Version history", on: () => fire("app:open-version-history") },
  ];
  ...
  document.addEventListener("keydown", (e) => {
    if ((e.metaKey || e.ctrlKey) && e.key.toLowerCase() === "k") {
      ...
      else if (k === "e") { e.preventDefault(); fire("app:export-dialog"); }
